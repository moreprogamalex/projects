   ...
   public class CgenerarFactura
    {
        public class CreaTicket
        {
            ...
            {
                string LineEncavesado = "Producto         Cant       P.Unit     Total      Desc";   // agrega lineas de  encabezados
            ...
            public void AgregaArticulo(string Articulo, double precio, int cant, double subtotal,double desc)
            {
                if (cant.ToString().Length <= 3 && precio.ToString("c").Length <= 10 && subtotal.ToString("c").Length <= 11 && desc.ToString("c").Length <= 11) // valida que cant precio y total esten dentro de rango
                {
                    ...
                    if (Articulo.Length > 40)                                 // **********
                    {
                        ...
                        nroEspacios = (11 - desc.ToString().Length);
                        espacios = "";
